...
def predicate_template(predicate = None, arguments = None):
    if predicate == None:
        predicate = new_var()
    if arguments == None:
        args_tree = new_var()
...
def match_neighbors(space,target):
    ''' find 8 neighbors of target
        target : a goal of neighbor Predicate 
    ...
    # four direction in the plane 
    ns = [(x-1,y,z),(x+1,y,z),(x,y-1,z),(x,y+1,z)]
    # jumping onto a block of four directon
